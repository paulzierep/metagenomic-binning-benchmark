...
> 🟢 **Agent status:** `running` · ⏱ `2026-09-23T22:10 CEST` · 🏃 train baseline_unmodified: epoch 139/200 · loss 2.8920135498046875 · top1 98.27799224853516 · 🧠 `big-pickle` · [status.log](status/status.log)
...
|---|---|---|---|---|---|---|---|---|---|---|
| `baseline_unmodified` | – | [987db95](https://github.com/paulzierep/COMEBin/commit/987db95d8d399f30b7c82a5f5f40ed6bfdc906c7) (upstream) | COMEBin demo (29,434 contigs) | 32 | – | – | – | – | – | ⏳ running · epoch 139/200 · loss 2.8920135498046875 · top1 98.27799224853516 |
