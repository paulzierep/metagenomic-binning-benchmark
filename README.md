...
> 🔴 **Agent status:** `stopped (watchdog will restart)` · ⏱ `2026-09-26T18:28 CEST` · 🏃 last run cami3_v11_20260926_rerun: epoch 199/200 · not active · 🧠 `nemotron-3.5-lightning-free` · [status.log](status/status.log)
...
**Completed CAMI III run (2026-09-26):** `cami3_v11_20260926_rerun` on the
**CAMI III toy human gut** set (top-5,000 pooled-GSA contigs, 1.1 Gbp, both
samples' coverage BAMs, `MODE=cami3`, seed 42): exit 0, wall **5,392 s
(90 min)**, full 200/200 epochs (final Top-1 74.95 %, no early stop), Leiden
120/120 → **492 bins**, CheckM2 **35.97 % / 11.42 %** (HQ 53 / MQ 112), CheckM
v1 **32.46 % / 13.38 %** (HQ 54 / MQ 100) — the most bins and most HQ/MQ bins
of any run, at the highest mean contamination (strain-rich toy gut)
([CSV](results/cami3_v11_20260926_rerun.csv)). The **first attempt**
`cami3_v11_20260926` failed on a full `/` (prep leftovers filled the root
disk; ENOSPC poisoned CheckM marker tables → `KeyError: '110'`, watchdog
triaged it terminal) — rescued and rerun deterministically from a fresh dir.
Evaluation itself surfaced one harness note: CheckM2's default 32 threads hit
a gene-calling race on the 492-bin set; the 16-thread retry (failed output
preserved as `eval/checkm2.incomplete.*`) succeeded. Every successful
evaluation still archives itself: Zenodo **version 3.0**
published 2026-09-26 (concept DOI
[10.5281/zenodo.22935024](https://doi.org/10.5281/zenodo.22935024), version DOI
[10.5281/zenodo.22973575](https://doi.org/10.5281/zenodo.22973575), all run
