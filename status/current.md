...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-26T05:52 CEST` |
| 🏃 Live benchmark | `cami3_v11_20260926` — **epoch 178/200** · loss `1.4391701221466064` · top1 acc `74.931640625` (log 0s fresh) |
...
| ⚙️ Load · uptime | `31.57 30.56 30.00` · 2 days, 14 hours, 16 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `3790/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `78b0b4e status: yes — cami3_v11_20260926 epoch 172/200 loss 1.507623553276062 ` |
