...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-26T12:58 CEST` |
| 🏃 Last benchmark (not active) | `cami3_v11_20260926_rerun` — last observed **epoch 199/200** (log 18062s old) |
...
| ⚙️ Load · uptime | `0.05 0.04 0.00` · 2 days, 21 hours, 22 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `2135/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `a36ee4e1 status: yes — cami3_v11_20260926_rerun epoch 199/200 loss 1.408849954` |
