...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-26T07:42 CEST` |
| 🏃 Live benchmark | `cami3_v11_20260926_rerun` — **epoch 154/200** · loss `1.6716514825820923` · top1 acc `67.451171875` (log 5s fresh) |
| 🧠 Model (last turn) | `muse-spark-1.3-contributor-free` (watchdog rotates to free models on quota) |
| 📌 Agent note · **18 min old** | 2026-09-25T12:16:00Z | marine_v11_20260925 active: epoch 147/200, COMEBin-v11@95f5ea8, cami2 mode; heartbeat touched; PROGRESS synced
...
| ⚙️ Load · uptime | `31.30 30.79 29.92` · 2 days, 16 hours, 6 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `5374/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `c4c6551 status: yes — cami3_v11_20260926_rerun epoch 148/200 loss 1.7165580987` |
