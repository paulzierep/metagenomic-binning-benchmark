...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-26T09:10 CEST` |
| 🏃 Last benchmark (not active) | `cami3_v11_20260926_rerun` — last observed **epoch 199/200** (log 4382s old) |
...
| ⚙️ Load · uptime | `0.14 7.64 14.50` · 2 days, 17 hours, 34 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `2147/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `7d7167ef status: yes — cami3_v11_20260926_rerun epoch 199/200 loss 1.408849954` |
| 📜 Agent transcript | [status/agent-run.log](status/agent-run.log) · `7459932 B` — every run, command & tool result |
