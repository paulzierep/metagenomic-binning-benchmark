...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-24T09:46 CEST` |
| 🏃 Last benchmark (not active) | `baseline_rerun_autorestart1` — last observed **epoch 176/200** (log 1846s old) |
...
| ⚙️ Load · uptime | `0.15 0.23 4.45` · 18 hours, 10 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `1916/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `fb98510 status: yes — baseline_rerun_autorestart1 epoch 176/200 loss 2.8607368` |
