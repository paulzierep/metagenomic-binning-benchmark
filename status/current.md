...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-25T07:22 CEST` |
| 🏃 Live benchmark | `marine_v11_20260925` — **epoch 16/200** · loss `1.8284412622451782` · top1 acc `73.34309387207031` (log 126s fresh) |
...
| ⚙️ Load · uptime | `31.47 31.09 30.30` · 1 day, 15 hours, 46 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `6493/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `6554813 status: yes — marine_v11_20260925 epoch 16/200 loss 1.8284412622451782` |
