...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-24T05:42 CEST` |
| 🏃 Live benchmark | `baseline_rerun_autorestart1` — **epoch 81/200** · loss `3.002840757369995` · top1 acc `97.08332824707031` (log 61s fresh) |
...
| ⚙️ Load · uptime | `30.87 31.17 31.45` · 14 hours, 6 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `9174/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `568a539 status: yes — baseline_rerun_autorestart1 epoch 80/200 loss 3.04201078` |
