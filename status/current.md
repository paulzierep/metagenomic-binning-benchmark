...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-26T11:26 CEST` |
| 🏃 Last benchmark (not active) | `cami3_v11_20260926_rerun` — last observed **epoch 199/200** (log 12542s old) |
...
| ⚙️ Load · uptime | `0.07 0.05 0.05` · 2 days, 19 hours, 50 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `2141/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `c206af03 status: yes — cami3_v11_20260926_rerun epoch 199/200 loss 1.408849954` |
