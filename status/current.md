...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-26T09:22 CEST` |
| 🏃 Last benchmark (not active) | `cami3_v11_20260926_rerun` — last observed **epoch 199/200** (log 5102s old) |
...
| ⚙️ Load · uptime | `11.54 12.51 13.88` · 2 days, 17 hours, 46 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `8191/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `00cb4a5d status: yes — cami3_v11_20260926_rerun epoch 199/200 loss 1.408849954` |
