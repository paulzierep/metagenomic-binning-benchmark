...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-26T12:18 CEST` |
| 🏃 Last benchmark (not active) | `cami3_v11_20260926_rerun` — last observed **epoch 199/200** (log 15663s old) |
...
| ⚙️ Load · uptime | `0.00 0.01 0.00` · 2 days, 20 hours, 42 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `2149/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `c52b3079 status: yes — cami3_v11_20260926_rerun epoch 199/200 loss 1.408849954` |
| 📜 Agent transcript | [status/agent-run.log](status/agent-run.log) · `7933464 B` — every run, command & tool result |
