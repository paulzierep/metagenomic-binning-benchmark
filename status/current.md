...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-26T06:16 CEST` |
| 🏃 Live benchmark | `cami3_v11_20260926` — **epoch 199/200** · loss `1.4088499546051025` · top1 acc `74.94791412353516` (log 1021s fresh) |
| 🧠 Model (last turn) | `mimo-v2.6-flash-free` (watchdog rotates to free models on quota) |
| 📌 Agent note · **76 min old** | 2026-09-25T12:16:00Z | marine_v11_20260925 active: epoch 147/200, COMEBin-v11@95f5ea8, cami2 mode; heartbeat touched; PROGRESS synced
...
| ⚙️ Load · uptime | `9.35 10.13 16.57` · 2 days, 14 hours, 40 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `4708/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `fbbe612 status: yes — cami3_v11_20260926 epoch 199/200 loss 1.4088499546051025` |
| 📜 Agent transcript | [status/agent-run.log](status/agent-run.log) · `7304538 B` — every run, command & tool result |
