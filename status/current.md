...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-25T06:28 CEST` |
...
| ⚙️ Load · uptime | `23.16 8.89 8.49` · 1 day, 14 hours, 52 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `4624/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `63c562d status: yes — marine_v11_20260925 epoch —/200 loss — acc — model` |
| 📜 Agent transcript | [status/agent-run.log](status/agent-run.log) · `3829773 B` — every run, command & tool result |
