...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-25T10:24 CEST` |
| 🏃 Live benchmark | `marine_v11_20260925` — **epoch 74/200** · loss `0.6533361673355103` · top1 acc `96.49739074707031` (log 85s fresh) |
...
| ⚙️ Load · uptime | `29.87 30.51 30.36` · 1 day, 18 hours, 48 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `6556/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `317b45d meta: supervise tick 2026-09-25T08:23:01Z — 0 fix(es)` |
