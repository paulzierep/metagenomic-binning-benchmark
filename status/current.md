...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-26T11:20 CEST` |
| 🏃 Last benchmark (not active) | `cami3_v11_20260926_rerun` — last observed **epoch 199/200** (log 12182s old) |
...
| ⚙️ Load · uptime | `0.00 0.03 0.06` · 2 days, 19 hours, 44 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `2138/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `422f0b64 status: yes — cami3_v11_20260926_rerun epoch 199/200 loss 1.408849954` |
| 📜 Agent transcript | [status/agent-run.log](status/agent-run.log) · `7784065 B` — every run, command & tool result |
