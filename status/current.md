...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-25T09:56 CEST` |
| 🏃 Live benchmark | `marine_v11_20260925` — **epoch 65/200** · loss `0.7496105432510376` · top1 acc `94.53775787353516` (log 101s fresh) |
...
| ⚙️ Load · uptime | `26.38 29.54 30.14` · 1 day, 18 hours, 20 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `6828/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `f686618 status: yes — marine_v11_20260925 epoch 64/200 loss 0.7471187710762024` |
| 📜 Agent transcript | [status/agent-run.log](status/agent-run.log) · `3904048 B` — every run, command & tool result |
