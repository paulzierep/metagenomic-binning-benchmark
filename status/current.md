...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-24T04:38 CEST` |
| 🏃 Live benchmark | `baseline_rerun_autorestart1` — **epoch 53/200** · loss `3.0979957580566406` · top1 acc `95.05533599853516` (log 6s fresh) |
...
| ⚙️ Load · uptime | `31.96 31.79 31.82` · 13 hours, 2 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `5896/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `5800815 status: yes — baseline_rerun_autorestart1 epoch 52/200 loss 3.11120271` |
