...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-26T09:54 CEST` |
| 🏃 Last benchmark (not active) | `cami3_v11_20260926_rerun` — last observed **epoch 199/200** (log 7022s old) |
...
| ⚙️ Load · uptime | `0.12 0.28 2.95` · 2 days, 18 hours, 18 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `2163/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `a057f021 docs: CAMI III run results (rerun 492 bins, CheckM2 35.97/11.42, CheckM` |
| 📜 Agent transcript | [status/agent-run.log](status/agent-run.log) · `7614051 B` — every run, command & tool result |
