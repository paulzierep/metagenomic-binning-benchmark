...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-24T03:38 CEST` |
| 🏃 Live benchmark | `baseline_rerun_autorestart1` — **epoch 26/200** · loss `3.250046968460083` · top1 acc `92.001953125` (log 10s fresh) |
...
| ⚙️ Load · uptime | `31.28 31.39 31.03` · 12 hours, 2 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `6401/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `a1cf7e9 status: yes — baseline_rerun_autorestart1 epoch 25/200 loss 3.27642416` |
