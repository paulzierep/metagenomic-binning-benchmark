...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-24T10:42 CEST` |
| 🏃 Last benchmark (not active) | `baseline_rerun_autorestart1` — last observed **epoch 176/200** (log 5206s old) |
...
| ⚙️ Load · uptime | `1.05 4.59 6.41` · 19 hours, 6 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `1905/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `d54ae24 docs: baseline rerun + eval complete (2026-09-24)` |
