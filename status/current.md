...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-24T02:46 CEST` |
| 🏃 Live benchmark | `baseline_rerun_autorestart1` — **epoch 2/200** · loss `5.349753379821777` · top1 acc `21.884765625` (log 99s fresh) |
...
| ⚙️ Load · uptime | `32.02 26.49 14.96` · 11 hours, 10 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `6543/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `b353585 status: yes — baseline_rerun_autorestart1 epoch 1/200 loss 5.825512886` |
