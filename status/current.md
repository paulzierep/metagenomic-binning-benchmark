...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-24T06:50 CEST` |
| 🏃 Live benchmark | `baseline_rerun_autorestart1` — **epoch 111/200** · loss `2.9446539878845215` · top1 acc `97.63346099853516` (log 95s fresh) |
...
| ⚙️ Load · uptime | `32.00 31.93 31.89` · 15 hours, 14 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `8918/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `7b3bfd1 status: yes — baseline_rerun_autorestart1 epoch 110/200 loss 2.9370787` |
