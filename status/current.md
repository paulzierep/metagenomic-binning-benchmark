...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-25T08:30 CEST` |
| 🏃 Live benchmark | `marine_v11_20260925` — **epoch 37/200** · loss `1.1918847560882568` · top1 acc `85.59244537353516` (log 164s fresh) |
...
| ⚙️ Load · uptime | `30.85 30.67 30.34` · 1 day, 16 hours, 54 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `7252/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `dda2d39 status: yes — marine_v11_20260925 epoch 37/200 loss 1.1918847560882568` |
| 📜 Agent transcript | [status/agent-run.log](status/agent-run.log) · `3859886 B` — every run, command & tool result |
