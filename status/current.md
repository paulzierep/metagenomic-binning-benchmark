...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-26T05:42 CEST` |
| 🏃 Live benchmark | `cami3_v11_20260926` — **epoch 148/200** · loss `1.7165580987930298` · top1 acc `66.64713287353516` (log 3s fresh) |
...
| ⚙️ Load · uptime | `29.77 29.23 29.43` · 2 days, 14 hours, 6 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `7640/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `0ee51b6 status: yes — cami3_v11_20260926 epoch 142/200 loss 1.8553375005722046` |
