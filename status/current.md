...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-25T05:20 CEST` |
| 🏃 Live benchmark | `human_v11_20260925` — **epoch 155/200** · loss `0.6200971603393555` · top1 acc `95.52082824707031` (log 8s fresh) |
...
| ⚙️ Load · uptime | `30.98 30.59 29.75` · 1 day, 13 hours, 44 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `7354/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `b706b82 status: yes — human_v11_20260925 epoch 149/200 loss 0.6440677642822266` |
