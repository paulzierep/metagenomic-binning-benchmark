...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-26T09:16 CEST` |
| 🏃 Last benchmark (not active) | `cami3_v11_20260926_rerun` — last observed **epoch 199/200** (log 4742s old) |
...
| ⚙️ Load · uptime | `16.22 13.04 14.63` · 2 days, 17 hours, 40 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `6039/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `c81c3ed4 meta: supervise tick 2026-09-26T07:13:01Z — 0 fix(es)` |
