...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-26T10:20 CEST` |
| 🏃 Last benchmark (not active) | `cami3_v11_20260926_rerun` — last observed **epoch 199/200** (log 8582s old) |
...
| ⚙️ Load · uptime | `0.33 0.09 0.58` · 2 days, 18 hours, 44 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `2116/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `5375602b status: no — cami3_v11_20260926_rerun epoch 199/200 loss 1.4088499546` |
