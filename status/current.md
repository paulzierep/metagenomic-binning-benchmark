...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-26T08:16 CEST` |
| 🏃 Live benchmark | `cami3_v11_20260926_rerun` — **epoch 199/200** · loss `1.4088499546051025` · top1 acc `74.94791412353516` (log 1142s fresh) |
| 🧠 Model (last turn) | `nemotron-3.5-lightning-free` (watchdog rotates to free models on quota) |
| 📌 Agent note · **52 min old** | 2026-09-25T12:16:00Z | marine_v11_20260925 active: epoch 147/200, COMEBin-v11@95f5ea8, cami2 mode; heartbeat touched; PROGRESS synced
...
| ⚙️ Load · uptime | `17.42 28.88 29.66` · 2 days, 16 hours, 40 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `3010/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `5ea1936 status: yes — cami3_v11_20260926_rerun epoch 199/200 loss 1.4088499546` |
| 📜 Agent transcript | [status/agent-run.log](status/agent-run.log) · `7407253 B` — every run, command & tool result |
