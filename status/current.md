...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-25T07:06 CEST` |
| 🏃 Live benchmark | `marine_v11_20260925` — **epoch 11/200** · loss `2.110262393951416` · top1 acc `67.56510162353516` (log 122s fresh) |
...
| ⚙️ Load · uptime | `31.79 31.29 29.07` · 1 day, 15 hours, 30 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `4826/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `579840a status: yes — marine_v11_20260925 epoch 11/200 loss 2.110262393951416 ` |
