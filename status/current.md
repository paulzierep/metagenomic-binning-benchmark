...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-26T07:34 CEST` |
| 🏃 Live benchmark | `cami3_v11_20260926_rerun` — **epoch 129/200** · loss `2.066105365753174` · top1 acc `57.662757873535156` (log 13s fresh) |
...
| ⚙️ Load · uptime | `32.25 31.61 29.43` · 2 days, 15 hours, 58 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `6134/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `190c216 meta: supervise tick 2026-09-26T05:33:01Z — 0 fix(es)` |
