...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-26T14:36 CEST` |
| 🏃 Last benchmark (not active) | `cami3_v11_20260926_rerun` — last observed **epoch 199/200** (log 23942s old) |
...
| ⚙️ Load · uptime | `0.26 0.10 0.02` · 2 days, 23 hours, 0 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `2140/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `6c68aa99 status: yes — cami3_v11_20260926_rerun epoch 199/200 loss 1.408849954` |
