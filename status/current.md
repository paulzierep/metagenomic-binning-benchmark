...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-26T05:46 CEST` |
| 🏃 Live benchmark | `cami3_v11_20260926` — **epoch 160/200** · loss `1.5916721820831299` · top1 acc `70.19856262207031` (log 1s fresh) |
...
| ⚙️ Load · uptime | `31.48 29.92 29.63` · 2 days, 14 hours, 10 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `4277/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `8f5c71a status: yes — cami3_v11_20260926 epoch 154/200 loss 1.6716514825820923` |
| 📜 Agent transcript | [status/agent-run.log](status/agent-run.log) · `7288554 B` — every run, command & tool result |
