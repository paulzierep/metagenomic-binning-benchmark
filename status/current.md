...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-24T06:54 CEST` |
| 🏃 Live benchmark | `baseline_rerun_autorestart1` — **epoch 113/200** · loss `2.9493439197540283` · top1 acc `97.63996887207031` (log 66s fresh) |
...
| ⚙️ Load · uptime | `32.06 32.03 31.96` · 15 hours, 18 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `7941/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `764e9c0 status: yes — baseline_rerun_autorestart1 epoch 112/200 loss 2.9383091` |
