...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-24T03:30 CEST` |
| 🏃 Live benchmark | `baseline_rerun_autorestart1` — **epoch 22/200** · loss `3.275824785232544` · top1 acc `91.25650787353516` (log 63s fresh) |
...
| ⚙️ Load · uptime | `31.38 31.46 30.72` · 11 hours, 54 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `6345/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `e3a48d8 status: yes — baseline_rerun_autorestart1 epoch 21/200 loss 3.28958940` |
