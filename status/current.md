...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-25T07:04 CEST` |
| 🏃 Live benchmark | `marine_v11_20260925` — **epoch 11/200** · loss `2.110262393951416` · top1 acc `67.56510162353516` (log 3s fresh) |
...
| ⚙️ Load · uptime | `31.91 31.14 28.73` · 1 day, 15 hours, 28 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `5621/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `648d5cc meta: supervise tick 2026-09-25T05:03:01Z — 0 fix(es)` |
