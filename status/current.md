...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-23T19:20 CEST` |
...
| ⚙️ Load · uptime | `31.94 31.41 31.41` · 3 hours, 44 minutes — 32 cores, 62 GiB, no GPU |
...
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `48285bb docs/01: marine sample-0 structure + COMEBin input plan (per-genome bams` |
