...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-24T06:18 CEST` |
| 🏃 Live benchmark | `baseline_rerun_autorestart1` — **epoch 97/200** · loss `2.9820058345794678` · top1 acc `97.22981262207031` (log 77s fresh) |
...
| ⚙️ Load · uptime | `31.58 31.14 31.35` · 14 hours, 42 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `7927/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `bf52cf5 status: yes — baseline_rerun_autorestart1 epoch 96/200 loss 2.96832418` |
