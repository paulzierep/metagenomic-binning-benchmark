...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-25T09:22 CEST` |
| 🏃 Live benchmark | `marine_v11_20260925` — **epoch 54/200** · loss `0.8633591532707214` · top1 acc `92.6171875` (log 113s fresh) |
...
| ⚙️ Load · uptime | `28.67 29.67 30.63` · 1 day, 17 hours, 46 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `6883/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `1a1c2a2 status: yes — marine_v11_20260925 epoch 53/200 loss 0.8696574568748474` |
