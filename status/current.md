...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-26T05:22 CEST` |
| 🏃 Live benchmark | `cami3_v11_20260926` — **epoch 88/200** · loss `3.3120667934417725` · top1 acc `30.40690040588379` (log 5s fresh) |
| 🧠 Model (last turn) | `big-pickle` (watchdog rotates to free models on quota) |
| 📌 Agent note · **22 min old** | 2026-09-25T12:16:00Z | marine_v11_20260925 active: epoch 147/200, COMEBin-v11@95f5ea8, cami2 mode; heartbeat touched; PROGRESS synced
...
| ⚙️ Load · uptime | `31.99 31.80 28.74` · 2 days, 13 hours, 46 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `5124/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `9e8f1f1 status: yes — cami3_v11_20260926 epoch 82/200 loss 3.595975637435913 a` |
| 📜 Agent transcript | [status/agent-run.log](status/agent-run.log) · `7285709 B` — every run, command & tool result |
