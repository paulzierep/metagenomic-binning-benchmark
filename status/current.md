...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-24T05:40 CEST` |
| 🏃 Live benchmark | `baseline_rerun_autorestart1` — **epoch 80/200** · loss `3.04201078414917` · top1 acc `96.15559387207031` (log 81s fresh) |
...
| ⚙️ Load · uptime | `32.01 31.88 31.71` · 14 hours, 4 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `6615/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `13408cf status: yes — baseline_rerun_autorestart1 epoch 79/200 loss 3.02177691` |
