...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-26T09:00 CEST` |
| 🏃 Last benchmark (not active) | `cami3_v11_20260926_rerun` — last observed **epoch 199/200** (log 3782s old) |
...
| ⚙️ Load · uptime | `37.80 32.72 21.45` · 2 days, 17 hours, 24 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `9746/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `bf0d7316 status: yes — cami3_v11_20260926_rerun epoch 199/200 loss 1.408849954` |
| 📜 Agent transcript | [status/agent-run.log](status/agent-run.log) · `7454791 B` — every run, command & tool result |
