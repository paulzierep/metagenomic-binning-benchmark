...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-24T09:16 CEST` |
| 🏃 Last benchmark (not active) | `baseline_rerun_autorestart1` — last observed **epoch 176/200** (log 46s old) |
...
| ⚙️ Load · uptime | `14.07 26.96 30.07` · 17 hours, 40 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `1957/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `b9dfa0a status: yes — baseline_rerun_autorestart1 epoch 175/200 loss 2.8544011` |
| 📜 Agent transcript | [status/agent-run.log](status/agent-run.log) · `1976613 B` — every run, command & tool result |
