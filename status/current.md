...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-24T11:02 CEST` |
| 🏃 Last benchmark (not active) | `small_test_v4` — last observed **epoch 29/30** (log 740s old) |
...
| ⚙️ Load · uptime | `0.45 1.15 2.68` · 19 hours, 26 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `1975/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `16de7d1 status: yes — small_test_v4 epoch 29/30 loss 5.521730899810791 acc 2.8` |
| 📜 Agent transcript | [status/agent-run.log](status/agent-run.log) · `2662662 B` — every run, command & tool result |
