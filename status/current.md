...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-25T10:20 CEST` |
| 🏃 Live benchmark | `marine_v11_20260925` — **epoch 73/200** · loss `0.6874424815177917` · top1 acc `96.640625` (log 36s fresh) |
...
| ⚙️ Load · uptime | `27.32 29.61 30.04` · 1 day, 18 hours, 44 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `7387/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `826484b status: yes — marine_v11_20260925 epoch 72/200 loss 0.6789799928665161` |
| 📜 Agent transcript | [status/agent-run.log](status/agent-run.log) · `4102481 B` — every run, command & tool result |
