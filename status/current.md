...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-24T06:38 CEST` |
| 🏃 Live benchmark | `baseline_rerun_autorestart1` — **epoch 106/200** · loss `2.9545936584472656` · top1 acc `97.95572662353516` (log 61s fresh) |
...
| ⚙️ Load · uptime | `32.01 31.95 31.75` · 15 hours, 2 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `8615/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `fbfb2e5 status: yes — baseline_rerun_autorestart1 epoch 105/200 loss 2.9709098` |
