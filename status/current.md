...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-25T05:36 CEST` |
| 🏃 Live benchmark | `human_v11_20260925` — **epoch 199/200** · loss `0.5311863422393799` · top1 acc `95.94075012207031` (log 119s fresh) |
...
| ⚙️ Load · uptime | `25.17 27.99 29.17` · 1 day, 14 hours, 0 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `2476/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `59db77f status: yes — human_v11_20260925 epoch 199/200 loss 0.5311863422393799` |
| 📜 Agent transcript | [status/agent-run.log](status/agent-run.log) · `3737722 B` — every run, command & tool result |
