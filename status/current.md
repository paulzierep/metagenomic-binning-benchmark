...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-26T15:38 CEST` |
| 🏃 Last benchmark (not active) | `cami3_v11_20260926_rerun` — last observed **epoch 199/200** (log 27662s old) |
...
| ⚙️ Load · uptime | `0.00 0.00 0.00` · 3 days, 2 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `2144/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `19cd8387 status: yes — cami3_v11_20260926_rerun epoch 199/200 loss 1.408849954` |
