...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-25T06:06 CEST` |
| 🏃 Last benchmark (not active) | `human_v11_20260925` — last observed **epoch 199/200** (log 1919s old) |
...
| ⚙️ Load · uptime | `1.12 1.93 8.35` · 1 day, 14 hours, 30 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `2274/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `a0f0189 status: marine prep monitor + #7 closing marker recorded` |
