...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-26T00:00 CEST` |
| 🏃 Last benchmark (not active) | `marine_v11_20260925` — last observed **epoch 158/200** (log 33245s old) |
...
| ⚙️ Load · uptime | `0.04 0.05 0.03` · 2 days, 8 hours, 24 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `1792/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `5de3502 status: yes — marine_v11_20260925 epoch 158/200 loss 0.402632415294647` |
