...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-24T04:02 CEST` |
| 🏃 Live benchmark | `baseline_rerun_autorestart1` — **epoch 36/200** · loss `3.193998098373413` · top1 acc `92.80598449707031` (log 113s fresh) |
...
| ⚙️ Load · uptime | `30.08 31.02 31.31` · 12 hours, 26 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `6450/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `56cce6e status: yes — baseline_rerun_autorestart1 epoch 35/200 loss 3.20616674` |
