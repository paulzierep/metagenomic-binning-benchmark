...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-26T07:32 CEST` |
| 🏃 Live benchmark | `cami3_v11_20260926_rerun` — **epoch 123/200** · loss `2.19331431388855` · top1 acc `53.701171875` (log 13s fresh) |
...
| ⚙️ Load · uptime | `31.16 31.28 29.04` · 2 days, 15 hours, 56 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `6510/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `c10f421 status: yes — cami3_v11_20260926_rerun epoch 117/200 loss 2.4291169643` |
