...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-26T07:36 CEST` |
| 🏃 Live benchmark | `cami3_v11_20260926_rerun` — **epoch 135/200** · loss `1.883526086807251` · top1 acc `62.21028518676758` (log 16s fresh) |
...
| ⚙️ Load · uptime | `30.26 31.26 29.59` · 2 days, 16 hours, 0 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `7098/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `748598f status: yes — cami3_v11_20260926_rerun epoch 129/200 loss 2.0661053657` |
