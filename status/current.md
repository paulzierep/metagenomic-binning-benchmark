...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-26T07:06 CEST` |
| 🏃 Live benchmark | `cami3_v11_20260926_rerun` — **epoch 44/200** · loss `4.660470008850098` · top1 acc `15.100911140441895` (log 5s fresh) |
...
| ⚙️ Load · uptime | `31.50 28.69 21.29` · 2 days, 15 hours, 30 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `5532/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `3bd0e5b status: yes — cami3_v11_20260926_rerun epoch 38/200 loss 4.95828342437` |
