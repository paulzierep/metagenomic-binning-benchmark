...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-26T10:36 CEST` |
| 🏃 Last benchmark (not active) | `cami3_v11_20260926_rerun` — last observed **epoch 199/200** (log 9543s old) |
...
| ⚙️ Load · uptime | `0.01 0.05 0.23` · 2 days, 19 hours, 0 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `2137/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `8e2ba5c7 status: yes — cami3_v11_20260926_rerun epoch 199/200 loss 1.408849954` |
| 📜 Agent transcript | [status/agent-run.log](status/agent-run.log) · `7716528 B` — every run, command & tool result |
