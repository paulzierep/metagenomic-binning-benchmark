...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-26T05:30 CEST` |
| 🏃 Live benchmark | `cami3_v11_20260926` — **epoch 112/200** · loss `2.543475866317749` · top1 acc `44.137367248535156` (log 4s fresh) |
| 🧠 Model (last turn) | `big-pickle` (watchdog rotates to free models on quota) |
| 📌 Agent note · **30 min old** | 2026-09-25T12:16:00Z | marine_v11_20260925 active: epoch 147/200, COMEBin-v11@95f5ea8, cami2 mode; heartbeat touched; PROGRESS synced
...
| ⚙️ Load · uptime | `32.02 31.71 29.91` · 2 days, 13 hours, 54 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `5230/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `a687124 status: yes — cami3_v11_20260926 epoch 106/200 loss 2.7222096920013428` |
