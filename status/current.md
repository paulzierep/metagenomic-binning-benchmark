...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-26T07:56 CEST` |
| 🏃 Live benchmark | `cami3_v11_20260926_rerun` — **epoch 196/200** · loss `1.4641568660736084` · top1 acc `73.0078125` (log 2s fresh) |
| 🧠 Model (last turn) | `muse-spark-1.3-contributor-free` (watchdog rotates to free models on quota) |
| 📌 Agent note · **32 min old** | 2026-09-25T12:16:00Z | marine_v11_20260925 active: epoch 147/200, COMEBin-v11@95f5ea8, cami2 mode; heartbeat touched; PROGRESS synced
...
| ⚙️ Load · uptime | `30.94 31.00 30.59` · 2 days, 16 hours, 20 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `6987/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `96156f2 status: yes — cami3_v11_20260926_rerun epoch 190/200 loss 1.4440833330` |
