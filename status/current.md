...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-24T03:22 CEST` |
| 🏃 Live benchmark | `baseline_rerun_autorestart1` — **epoch 18/200** · loss `3.3630211353302` · top1 acc `89.02668762207031` (log 118s fresh) |
...
| ⚙️ Load · uptime | `32.39 31.73 30.18` · 11 hours, 46 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `8557/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `0bf961b status: yes — baseline_rerun_autorestart1 epoch 17/200 loss 3.36750006` |
