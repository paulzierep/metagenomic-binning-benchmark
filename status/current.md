...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-26T05:54 CEST` |
| 🏃 Live benchmark | `cami3_v11_20260926` — **epoch 183/200** · loss `1.4093270301818848` · top1 acc `76.65364074707031` (log 19s fresh) |
...
| ⚙️ Load · uptime | `31.99 31.07 30.26` · 2 days, 14 hours, 18 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `5407/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `6c006a5 meta: supervise tick 2026-09-26T03:53:01Z — 0 fix(es)` |
