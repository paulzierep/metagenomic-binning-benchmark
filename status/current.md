...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-26T07:44 CEST` |
| 🏃 Live benchmark | `cami3_v11_20260926_rerun` — **epoch 160/200** · loss `1.5916721820831299` · top1 acc `70.19856262207031` (log 6s fresh) |
...
| ⚙️ Load · uptime | `30.06 30.77 30.04` · 2 days, 16 hours, 8 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `4981/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `d97c0d8 meta: supervise tick 2026-09-26T05:43:01Z — 0 fix(es)` |
