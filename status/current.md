...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-26T06:48 CEST` |
| 🏃 Last benchmark (not active) | `cami3_v11_20260926` — last observed **epoch 199/200** (log 2940s old) |
...
| ⚙️ Load · uptime | `0.05 1.89 8.92` · 2 days, 15 hours, 12 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `2351/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `9f2f028 status: yes — cami3_v11_20260926 epoch 199/200 loss 1.4088499546051025` |
| 📜 Agent transcript | [status/agent-run.log](status/agent-run.log) · `7331608 B` — every run, command & tool result |
