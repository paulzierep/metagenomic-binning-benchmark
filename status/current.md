...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-25T09:42 CEST` |
| 🏃 Live benchmark | `marine_v11_20260925` — **epoch 61/200** · loss `0.7439138889312744` · top1 acc `95.13346099853516` (log 1s fresh) |
...
| ⚙️ Load · uptime | `31.88 30.93 30.48` · 1 day, 18 hours, 6 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `4297/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `c1a63d5 status: yes — marine_v11_20260925 epoch 60/200 loss 0.7598490118980408` |
