...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-26T08:00 CEST` |
| 🏃 Live benchmark | `cami3_v11_20260926_rerun` — **epoch 199/200** · loss `1.4088499546051025` · top1 acc `74.94791412353516` (log 182s fresh) |
| 🧠 Model (last turn) | `muse-spark-1.3-contributor-free` (watchdog rotates to free models on quota) |
| 📌 Agent note · **36 min old** | 2026-09-25T12:16:00Z | marine_v11_20260925 active: epoch 147/200, COMEBin-v11@95f5ea8, cami2 mode; heartbeat touched; PROGRESS synced
...
| ⚙️ Load · uptime | `34.78 31.06 30.53` · 2 days, 16 hours, 24 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `6459/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `80a9b36 status: yes — cami3_v11_20260926_rerun epoch 199/200 loss 1.4088499546` |
| 📜 Agent transcript | [status/agent-run.log](status/agent-run.log) · `7350020 B` — every run, command & tool result |
