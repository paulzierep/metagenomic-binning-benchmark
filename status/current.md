...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-24T05:22 CEST` |
| 🏃 Live benchmark | `baseline_rerun_autorestart1` — **epoch 72/200** · loss `3.0474014282226562` · top1 acc `95.478515625` (log 81s fresh) |
...
| ⚙️ Load · uptime | `32.07 31.68 31.49` · 13 hours, 46 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `6800/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `cef43b9 status: yes — baseline_rerun_autorestart1 epoch 71/200 loss 3.04577469` |
