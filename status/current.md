...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-26T04:10 CEST` |
| 🏃 Last benchmark (not active) | `marine_v11_20260925` — last observed **epoch 158/200** (log 48245s old) |
...
| ⚙️ Load · uptime | `1.08 1.16 2.89` · 2 days, 12 hours, 34 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `2767/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `6624cbb status: yes — marine_v11_20260925 epoch 158/200 loss 0.402632415294647` |
