...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-25T10:10 CEST` |
| 🏃 Live benchmark | `marine_v11_20260925` — **epoch 69/200** · loss `0.7039782404899597` · top1 acc `95.73567199707031` (log 187s fresh) |
| 🧠 Model (last turn) | `nemotron-3.5-lightning-free` (watchdog rotates to free models on quota) |
| 📌 Agent note · **11 min old** | Baseline training epoch ~109/200 (~2.4 min/epoch, ETA ~22:35 UTC unless early-stop); next: baseline eval (run_eval.sh) → issue #2 small-dataset test → v1.1.0 fix run
...
| ⚙️ Load · uptime | `27.93 29.38 30.07` · 1 day, 18 hours, 34 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `7656/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `2d6a95c status: yes — marine_v11_20260925 epoch 69/200 loss 0.7039782404899597` |
