...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-25T08:38 CEST` |
| 🏃 Live benchmark | `marine_v11_20260925` — **epoch 40/200** · loss `1.1591086387634277` · top1 acc `85.771484375` (log 82s fresh) |
...
| ⚙️ Load · uptime | `31.36 31.49 30.99` · 1 day, 17 hours, 2 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `5575/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `f7050ae status: yes — marine_v11_20260925 epoch 39/200 loss 1.153309941291809 ` |
