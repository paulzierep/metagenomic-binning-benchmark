...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-26T05:34 CEST` |
| 🏃 Live benchmark | `cami3_v11_20260926` — **epoch 124/200** · loss `2.195018768310547` · top1 acc `53.444007873535156` (log 4s fresh) |
...
| ⚙️ Load · uptime | `32.12 31.95 30.42` · 2 days, 13 hours, 58 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `6338/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `80c413a meta: supervise tick 2026-09-26T03:33:01Z — 0 fix(es)` |
