...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-25T09:26 CEST` |
| 🏃 Live benchmark | `marine_v11_20260925` — **epoch 55/200** · loss `0.8051892518997192` · top1 acc `93.974609375` (log 167s fresh) |
...
| ⚙️ Load · uptime | `29.63 29.04 30.11` · 1 day, 17 hours, 50 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `6988/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `70949b5 status: yes — marine_v11_20260925 epoch 55/200 loss 0.8051892518997192` |
