...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-26T06:54 CEST` |
| 🏃 Live benchmark | `cami3_v11_20260926_rerun` — **epoch 7/200** · loss `7.234864711761475` · top1 acc `1.8001301288604736` (log 9s fresh) |
...
| ⚙️ Load · uptime | `28.91 13.51 11.03` · 2 days, 15 hours, 18 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `7466/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `7040a25 meta: supervise tick 2026-09-26T04:53:01Z — 0 fix(es)` |
