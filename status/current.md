...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-26T07:54 CEST` |
| 🏃 Live benchmark | `cami3_v11_20260926_rerun` — **epoch 190/200** · loss `1.444083333015442` · top1 acc `74.56705474853516` (log 2s fresh) |
...
| ⚙️ Load · uptime | `31.76 31.10 30.55` · 2 days, 16 hours, 18 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `6579/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `7337921 meta: supervise tick 2026-09-26T05:53:01Z — 0 fix(es)` |
