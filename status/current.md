...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-25T10:22 CEST` |
| 🏃 Live benchmark | `marine_v11_20260925` — **epoch 73/200** · loss `0.6874424815177917` · top1 acc `96.640625` (log 156s fresh) |
...
| ⚙️ Load · uptime | `31.54 30.49 30.31` · 1 day, 18 hours, 46 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `7715/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `a6da1b3 status: yes — marine_v11_20260925 epoch 73/200 loss 0.6874424815177917` |
| 📜 Agent transcript | [status/agent-run.log](status/agent-run.log) · `4138237 B` — every run, command & tool result |
