...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-24T06:28 CEST` |
| 🏃 Live benchmark | `baseline_rerun_autorestart1` — **epoch 102/200** · loss `2.9766361713409424` · top1 acc `97.16145324707031` (log 2s fresh) |
...
| ⚙️ Load · uptime | `29.59 31.33 31.46` · 14 hours, 52 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `6143/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `14682a8 status: yes — baseline_rerun_autorestart1 epoch 101/200 loss 2.9557027` |
