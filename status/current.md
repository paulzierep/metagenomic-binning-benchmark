...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-26T08:56 CEST` |
| 🏃 Last benchmark (not active) | `cami3_v11_20260926_rerun` — last observed **epoch 199/200** (log 3543s old) |
...
| ⚙️ Load · uptime | `36.66 26.78 16.72` · 2 days, 17 hours, 20 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `9483/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `f1ef1fb0 meta: supervise tick 2026-09-26T06:53:01Z — 0 fix(es)` |
