...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-25T07:08 CEST` |
| 🏃 Live benchmark | `marine_v11_20260925` — **epoch 12/200** · loss `1.93668794631958` · top1 acc `70.63801574707031` (log 49s fresh) |
...
| ⚙️ Load · uptime | `31.12 31.18 29.30` · 1 day, 15 hours, 32 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `6670/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `e57ced4 status: yes — marine_v11_20260925 epoch 11/200 loss 2.110262393951416 ` |
