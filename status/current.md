...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-26T07:04 CEST` |
| 🏃 Live benchmark | `cami3_v11_20260926_rerun` — **epoch 38/200** · loss `4.958283424377441` · top1 acc `12.281900405883789` (log 0s fresh) |
...
| ⚙️ Load · uptime | `31.00 27.56 19.97` · 2 days, 15 hours, 28 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `4080/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `62123ce meta: supervise tick 2026-09-26T05:03:01Z — 0 fix(es)` |
