...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-26T15:28 CEST` |
| 🏃 Last benchmark (not active) | `cami3_v11_20260926_rerun` — last observed **epoch 199/200** (log 27062s old) |
...
| ⚙️ Load · uptime | `0.04 0.03 0.00` · 2 days, 23 hours, 52 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `2144/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `cb07d447 status: yes — cami3_v11_20260926_rerun epoch 199/200 loss 1.408849954` |
| 📜 Agent transcript | [status/agent-run.log](status/agent-run.log) · `8425383 B` — every run, command & tool result |
