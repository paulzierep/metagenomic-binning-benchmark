...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-25T09:24 CEST` |
| 🏃 Live benchmark | `marine_v11_20260925` — **epoch 55/200** · loss `0.8051892518997192` · top1 acc `93.974609375` (log 47s fresh) |
...
| ⚙️ Load · uptime | `27.32 28.78 30.19` · 1 day, 17 hours, 48 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `5326/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `cbd2e18 meta: supervise tick 2026-09-25T07:23:01Z — 0 fix(es)` |
