...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-24T03:16 CEST` |
| 🏃 Live benchmark | `baseline_rerun_autorestart1` — **epoch 16/200** · loss `3.4180705547332764` · top1 acc `87.68228912353516` (log 24s fresh) |
...
| ⚙️ Load · uptime | `30.54 31.38 29.40` · 11 hours, 40 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `7449/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `00fee00 status: yes — baseline_rerun_autorestart1 epoch 15/200 loss 3.40370249` |
