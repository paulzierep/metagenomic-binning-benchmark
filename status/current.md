...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-24T04:56 CEST` |
| 🏃 Live benchmark | `baseline_rerun_autorestart1` — **epoch 61/200** · loss `3.089294910430908` · top1 acc `94.98697662353516` (log 13s fresh) |
...
| ⚙️ Load · uptime | `29.97 30.88 31.44` · 13 hours, 20 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `7026/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `ab20108 status: yes — baseline_rerun_autorestart1 epoch 60/200 loss 3.08817148` |
