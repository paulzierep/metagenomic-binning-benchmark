...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-26T14:38 CEST` |
| 🏃 Last benchmark (not active) | `cami3_v11_20260926_rerun` — last observed **epoch 199/200** (log 24063s old) |
...
| ⚙️ Load · uptime | `0.17 0.09 0.02` · 2 days, 23 hours, 2 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `2143/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `bcd393a0 status: yes — cami3_v11_20260926_rerun epoch 199/200 loss 1.408849954` |
| 📜 Agent transcript | [status/agent-run.log](status/agent-run.log) · `8245525 B` — every run, command & tool result |
