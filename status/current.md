...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-26T05:10 CEST` |
| 🏃 Live benchmark | `cami3_v11_20260926` — **epoch 54/200** · loss `4.405590534210205` · top1 acc `17.451171875` (log 3s fresh) |
...
| ⚙️ Load · uptime | `33.82 32.82 25.17` · 2 days, 13 hours, 34 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `7207/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `2c5d633 status: yes — cami3_v11_20260926 epoch 49/200 loss 4.542250633239746 a` |
| 📜 Agent transcript | [status/agent-run.log](status/agent-run.log) · `7282135 B` — every run, command & tool result |
