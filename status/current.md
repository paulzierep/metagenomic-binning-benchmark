...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-26T07:12 CEST` |
| 🏃 Live benchmark | `cami3_v11_20260926_rerun` — **epoch 62/200** · loss `4.252568244934082` · top1 acc `19.287109375` (log 15s fresh) |
...
| ⚙️ Load · uptime | `27.11 28.37 23.66` · 2 days, 15 hours, 36 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `5473/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `0504dee status: yes — cami3_v11_20260926_rerun epoch 56/200 loss 4.36100673675` |
