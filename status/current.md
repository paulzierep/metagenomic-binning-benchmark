...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-25T09:20 CEST` |
| 🏃 Live benchmark | `marine_v11_20260925` — **epoch 53/200** · loss `0.8696574568748474` · top1 acc `92.05728912353516` (log 180s fresh) |
...
| ⚙️ Load · uptime | `28.78 30.32 30.96` · 1 day, 17 hours, 44 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `6286/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `065fe72 status: yes — marine_v11_20260925 epoch 53/200 loss 0.8696574568748474` |
| 📜 Agent transcript | [status/agent-run.log](status/agent-run.log) · `3870967 B` — every run, command & tool result |
