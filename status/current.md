...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-26T06:46 CEST` |
| 🏃 Last benchmark (not active) | `cami3_v11_20260926` — last observed **epoch 199/200** (log 2820s old) |
...
| ⚙️ Load · uptime | `0.05 2.81 10.15` · 2 days, 15 hours, 10 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `2327/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `0637288 status: yes — cami3_v11_20260926 epoch 199/200 loss 1.4088499546051025` |
