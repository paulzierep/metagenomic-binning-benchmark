...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-26T05:04 CEST` |
| 🏃 Live benchmark | `cami3_v11_20260926` — **epoch 39/200** · loss `4.906659126281738` · top1 acc `13.785806655883789` (log 3s fresh) |
...
| ⚙️ Load · uptime | `32.70 31.24 21.21` · 2 days, 13 hours, 28 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `10600/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `a8ae653 meta: supervise tick 2026-09-26T03:03:01Z — 0 fix(es)` |
