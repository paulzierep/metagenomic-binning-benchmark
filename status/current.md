...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-26T08:46 CEST` |
| 🏃 Last benchmark (not active) | `cami3_v11_20260926_rerun` — last observed **epoch 199/200** (log 2942s old) |
...
| ⚙️ Load · uptime | `1.27 1.72 8.29` · 2 days, 17 hours, 10 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `38226/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `99c127db meta: supervise tick 2026-09-26T06:43:01Z — 0 fix(es)` |
