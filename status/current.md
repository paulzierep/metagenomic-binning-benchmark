...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-24T13:00 CEST` |
| 🏃 Live benchmark | `fix_v11_20260924` — **epoch 7/200** · loss `3.887873649597168` · top1 acc `76.40950012207031` (log 25s fresh) |
...
| ⚙️ Load · uptime | `30.93 29.35 21.66` · 21 hours, 24 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `5382/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `946f655 status: yes — fix_v11_20260924 epoch 6/200 loss 4.023188591003418 acc ` |
