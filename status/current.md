...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-26T08:42 CEST` |
| 🏃 Last benchmark (not active) | `cami3_v11_20260926_rerun` — last observed **epoch 199/200** (log 2702s old) |
...
| ⚙️ Load · uptime | `1.02 2.38 10.40` · 2 days, 17 hours, 6 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `38240/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `5b66350e status: yes — cami3_v11_20260926_rerun epoch 199/200 loss 1.408849954` |
