...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-26T10:12 CEST` |
| 🏃 Last benchmark (not active) | `cami3_v11_20260926_rerun` — last observed **epoch 199/200** (log 8102s old) |
...
| ⚙️ Load · uptime | `0.04 0.05 0.94` · 2 days, 18 hours, 36 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `2120/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `0a862649 status: yes — cami3_v11_20260926_rerun epoch 199/200 loss 1.408849954` |
