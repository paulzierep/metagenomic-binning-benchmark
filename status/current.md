...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-25T03:50 CEST` |
| 🏃 Last benchmark (not active) | `tiny_test_n101` — last observed **epoch 29/30** (log 166s old) |
...
| ⚙️ Load · uptime | `2.72 2.22 1.36` · 1 day, 12 hours, 14 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `19186/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `f9f5a1a status: yes — tiny_test_n101 epoch 29/30 loss 4.71933126449585 acc 6.9` |
| 📜 Agent transcript | [status/agent-run.log](status/agent-run.log) · `3593450 B` — every run, command & tool result |
