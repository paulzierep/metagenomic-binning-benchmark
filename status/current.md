...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-25T06:26 CEST` |
...
| ⚙️ Load · uptime | `1.16 2.50 6.78` · 1 day, 14 hours, 50 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `2138/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `94cbaa2 status: yes — marine_v11_20260925 epoch —/200 loss — acc — model` |
