...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-25T08:32 CEST` |
| 🏃 Live benchmark | `marine_v11_20260925` — **epoch 38/200** · loss `1.1757171154022217` · top1 acc `85.39387512207031` (log 96s fresh) |
...
| ⚙️ Load · uptime | `33.50 31.71 30.76` · 1 day, 16 hours, 56 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `6831/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `1071b85 status: yes — marine_v11_20260925 epoch 37/200 loss 1.1918847560882568` |
