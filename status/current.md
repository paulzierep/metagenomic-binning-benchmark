...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-24T06:52 CEST` |
| 🏃 Live benchmark | `baseline_rerun_autorestart1` — **epoch 112/200** · loss `2.9383091926574707` · top1 acc `98.056640625` (log 78s fresh) |
...
| ⚙️ Load · uptime | `32.13 32.02 31.93` · 15 hours, 16 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `7742/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `56eaa6b status: yes — baseline_rerun_autorestart1 epoch 111/200 loss 2.9446539` |
