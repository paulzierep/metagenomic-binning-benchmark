...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-24T13:02 CEST` |
| 🏃 Live benchmark | `fix_v11_20260924` — **epoch 8/200** · loss `3.765296459197998` · top1 acc `79.44660949707031` (log 14s fresh) |
...
| ⚙️ Load · uptime | `30.16 29.13 22.48` · 21 hours, 26 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `7331/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `5b5f685 status: yes — fix_v11_20260924 epoch 7/200 loss 3.887873649597168 acc ` |
