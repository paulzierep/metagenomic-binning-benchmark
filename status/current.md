...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-25T04:56 CEST` |
| 🏃 Live benchmark | `human_v11_20260925` — **epoch 81/200** · loss `2.6416921615600586` · top1 acc `55.80403518676758` (log 2s fresh) |
...
| ⚙️ Load · uptime | `30.90 30.65 26.42` · 1 day, 13 hours, 20 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `5856/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `f42f012 status: yes — human_v11_20260925 epoch 74/200 loss 3.0852153301239014 ` |
