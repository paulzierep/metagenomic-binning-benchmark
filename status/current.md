...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-24T09:50 CEST` |
| 🏃 Last benchmark (not active) | `baseline_rerun_autorestart1` — last observed **epoch 176/200** (log 2086s old) |
...
| ⚙️ Load · uptime | `0.08 0.17 3.44` · 18 hours, 14 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `1923/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `7cc51fe status: yes — baseline_rerun_autorestart1 epoch 176/200 loss 2.8607368` |
