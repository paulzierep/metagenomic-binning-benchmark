...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-26T06:38 CEST` |
| 🏃 Live benchmark | `cami3_v11_20260926` — **epoch 199/200** · loss `1.4088499546051025` · top1 acc `74.94791412353516` (log 2340s fresh) |
...
| ⚙️ Load · uptime | `0.87 13.94 17.02` · 2 days, 15 hours, 2 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `2334/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `99ae578 status: yes — cami3_v11_20260926 epoch 199/200 loss 1.4088499546051025` |
| 📜 Agent transcript | [status/agent-run.log](status/agent-run.log) · `7320360 B` — every run, command & tool result |
