...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-25T23:58 CEST` |
| 🏃 Last benchmark (not active) | `marine_v11_20260925` — last observed **epoch 158/200** (log 33125s old) |
...
| ⚙️ Load · uptime | `0.01 0.06 0.03` · 2 days, 8 hours, 22 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `1818/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `1040987 status: yes — marine_v11_20260925 epoch 158/200 loss 0.402632415294647` |
| 📜 Agent transcript | [status/agent-run.log](status/agent-run.log) · `5975367 B` — every run, command & tool result |
