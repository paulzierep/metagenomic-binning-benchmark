...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-26T05:44 CEST` |
| 🏃 Live benchmark | `cami3_v11_20260926` — **epoch 154/200** · loss `1.6716514825820923` · top1 acc `67.451171875` (log 2s fresh) |
| 🧠 Model (last turn) | `big-pickle` (watchdog rotates to free models on quota) |
| 📌 Agent note · **44 min old** | 2026-09-25T12:16:00Z | marine_v11_20260925 active: epoch 147/200, COMEBin-v11@95f5ea8, cami2 mode; heartbeat touched; PROGRESS synced
...
| ⚙️ Load · uptime | `27.72 28.85 29.28` · 2 days, 14 hours, 8 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `5737/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `532b6c6 meta: supervise tick 2026-09-26T03:43:01Z — 0 fix(es)` |
