...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-26T16:50 CEST` |
| 🏃 Last benchmark (not active) | `cami3_v11_20260926_rerun` — last observed **epoch 199/200** (log 31982s old) |
...
| ⚙️ Load · uptime | `0.21 0.10 0.02` · 3 days, 1 hour, 14 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `2167/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `5183b2ab status: yes — cami3_v11_20260926_rerun epoch 199/200 loss 1.408849954` |
