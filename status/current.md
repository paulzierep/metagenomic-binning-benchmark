...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-25T03:12 CEST` |
| 🏃 Last benchmark (not active) | `fix_v11_20260924` — last observed **epoch 183/200** (log 28031s old) |
...
| ⚙️ Load · uptime | `8.90 4.21 1.90` · 1 day, 11 hours, 36 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `2266/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `6cb8d4e status: yes — fix_v11_20260924 epoch 183/200 loss 2.835580348968506 ac` |
