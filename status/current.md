...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-26T18:02 CEST` |
| 🏃 Last benchmark (not active) | `cami3_v11_20260926_rerun` — last observed **epoch 199/200** (log 36302s old) |
...
| ⚙️ Load · uptime | `0.08 0.06 0.03` · 3 days, 2 hours, 26 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `2149/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `463aa24a status: yes — cami3_v11_20260926_rerun epoch 199/200 loss 1.408849954` |
| 📜 Agent transcript | [status/agent-run.log](status/agent-run.log) · `8884664 B` — every run, command & tool result |
