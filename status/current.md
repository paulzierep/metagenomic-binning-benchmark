...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-25T06:10 CEST` |
| 🏃 Last benchmark (not active) | `human_v11_20260925` — last observed **epoch 199/200** (log 2159s old) |
...
| ⚙️ Load · uptime | `31.03 15.18 11.97` · 1 day, 14 hours, 34 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `11699/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `d5f8134 status: yes — human_v11_20260925 epoch 199/200 loss 0.5311863422393799` |
| 📜 Agent transcript | [status/agent-run.log](status/agent-run.log) · `3801750 B` — every run, command & tool result |
