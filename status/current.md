...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-26T08:36 CEST` |
| 🏃 Last benchmark (not active) | `cami3_v11_20260926_rerun` — last observed **epoch 199/200** (log 2342s old) |
...
| ⚙️ Load · uptime | `1.10 5.55 14.85` · 2 days, 17 hours, 0 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `38235/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `658bab22 meta: supervise tick 2026-09-26T06:33:01Z — 0 fix(es)` |
