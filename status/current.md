...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-26T06:00 CEST` |
| 🏃 Live benchmark | `cami3_v11_20260926` — **epoch 199/200** · loss `1.4088499546051025` · top1 acc `74.94791412353516` (log 60s fresh) |
| 🧠 Model (last turn) | `big-pickle` (watchdog rotates to free models on quota) |
| 📌 Agent note · **60 min old** | 2026-09-25T12:16:00Z | marine_v11_20260925 active: epoch 147/200, COMEBin-v11@95f5ea8, cami2 mode; heartbeat touched; PROGRESS synced
...
| ⚙️ Load · uptime | `22.84 28.99 29.87` · 2 days, 14 hours, 24 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `3734/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `b6c3dca status: yes — cami3_v11_20260926 epoch 196/200 loss 1.4641568660736084` |
| 📜 Agent transcript | [status/agent-run.log](status/agent-run.log) · `7289548 B` — every run, command & tool result |
