...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-26T17:33 CEST` |
| 🏃 Last benchmark (not active) | `cami3_v11_20260926_rerun` — last observed **epoch 199/200** (log 34564s old) |
...
| ⚙️ Load · uptime | `0.08 0.05 0.05` · 3 days, 1 hour, 57 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `2236/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `eb6c22db status: yes — cami3_v11_20260926_rerun epoch 199/200 loss 1.408849954` |
| 📜 Agent transcript | [status/agent-run.log](status/agent-run.log) · `8827470 B` — every run, command & tool result |
