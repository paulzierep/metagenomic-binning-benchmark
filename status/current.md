...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-25T05:18 CEST` |
| 🏃 Live benchmark | `human_v11_20260925` — **epoch 149/200** · loss `0.6440677642822266` · top1 acc `95.07160949707031` (log 3s fresh) |
...
| ⚙️ Load · uptime | `31.74 30.97 29.77` · 1 day, 13 hours, 42 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `5507/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `0629376 status: yes — human_v11_20260925 epoch 143/200 loss 0.6740553975105286` |
