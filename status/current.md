...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-25T06:16 CEST` |
...
| ⚙️ Load · uptime | `1.74 10.63 11.80` · 1 day, 14 hours, 40 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `2201/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `cb382fe status: yes — human_v11_20260925 epoch 199/200 loss 0.5311863422393799` |
| 📜 Agent transcript | [status/agent-run.log](status/agent-run.log) · `3822082 B` — every run, command & tool result |
