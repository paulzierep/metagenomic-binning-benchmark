...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-24T06:20 CEST` |
| 🏃 Live benchmark | `baseline_rerun_autorestart1` — **epoch 98/200** · loss `2.9792966842651367` · top1 acc `97.36002349853516` (log 62s fresh) |
...
| ⚙️ Load · uptime | `32.27 31.53 31.47` · 14 hours, 44 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `8013/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `1aeda28 status: yes — baseline_rerun_autorestart1 epoch 97/200 loss 2.98200583` |
