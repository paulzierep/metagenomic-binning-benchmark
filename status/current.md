...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-24T03:36 CEST` |
| 🏃 Live benchmark | `baseline_rerun_autorestart1` — **epoch 25/200** · loss `3.2764241695404053` · top1 acc `91.025390625` (log 25s fresh) |
...
| ⚙️ Load · uptime | `31.89 31.64 31.06` · 12 hours, 0 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `5946/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `671ac30 status: yes — baseline_rerun_autorestart1 epoch 24/200 loss 3.29431223` |
