...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-24T11:42 CEST` |
| 🏃 Live benchmark | `medium_v11_20260924` — **epoch 82/200** · loss `4.853684902191162` · top1 acc `33.876953125` (log 3s fresh) |
...
| ⚙️ Load · uptime | `31.55 29.00 19.91` · 20 hours, 6 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `7292/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `86d0836 status: yes — medium_v11_20260924 epoch 71/200 loss 5.001936435699463 ` |
