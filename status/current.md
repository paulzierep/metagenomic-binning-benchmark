...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-24T13:16 CEST` |
| 🏃 Live benchmark | `fix_v11_20260924` — **epoch 14/200** · loss `3.457880973815918` · top1 acc `87.41861724853516` (log 62s fresh) |
...
| ⚙️ Load · uptime | `29.37 29.69 26.96` · 21 hours, 40 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `5621/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `e6d9bdd status: yes — fix_v11_20260924 epoch 13/200 loss 3.460366725921631 acc` |
