...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-26T05:32 CEST` |
| 🏃 Live benchmark | `cami3_v11_20260926` — **epoch 118/200** · loss `2.3566408157348633` · top1 acc `49.658203125` (log 4s fresh) |
...
| ⚙️ Load · uptime | `32.15 31.86 30.18` · 2 days, 13 hours, 56 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `5641/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `f3662f7 status: yes — cami3_v11_20260926 epoch 112/200 loss 2.543475866317749 ` |
