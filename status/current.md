...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-26T07:30 CEST` |
| 🏃 Live benchmark | `cami3_v11_20260926_rerun` — **epoch 117/200** · loss `2.42911696434021` · top1 acc `47.75716018676758` (log 13s fresh) |
...
| ⚙️ Load · uptime | `32.32 31.51 28.79` · 2 days, 15 hours, 54 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `7719/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `102e34a status: yes — cami3_v11_20260926_rerun epoch 111/200 loss 2.5438234806` |
