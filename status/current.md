...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-24T06:16 CEST` |
| 🏃 Live benchmark | `baseline_rerun_autorestart1` — **epoch 96/200** · loss `2.9683241844177246` · top1 acc `97.38932037353516` (log 92s fresh) |
...
| ⚙️ Load · uptime | `31.42 31.21 31.41` · 14 hours, 40 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `5914/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `59bfae2 status: yes — baseline_rerun_autorestart1 epoch 95/200 loss 2.99932122` |
