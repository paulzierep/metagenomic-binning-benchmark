...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-26T07:02 CEST` |
| 🏃 Live benchmark | `cami3_v11_20260926_rerun` — **epoch 31/200** · loss `5.252328395843506` · top1 acc `10.299478530883789` (log 16s fresh) |
...
| ⚙️ Load · uptime | `26.64 25.66 18.40` · 2 days, 15 hours, 26 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `7228/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `79e1400 status: yes — cami3_v11_20260926_rerun epoch 25/200 loss 5.61671447753` |
