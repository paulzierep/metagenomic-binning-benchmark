...
|---|---|
| Status | 🟢 `running` |
| ⏱ Updated (Europe/Berlin) | `2026-09-26T13:08 CEST` |
| 🏃 Last benchmark (not active) | `cami3_v11_20260926_rerun` — last observed **epoch 199/200** (log 18662s old) |
...
| ⚙️ Load · uptime | `0.06 0.11 0.09` · 2 days, 21 hours, 32 minutes — 32 cores, 62 GiB, no GPU |
| 💾 RAM used/total | `2136/64295 MB` |
| 🔗 Session | `ses_f31799c77ffeTq9gcYgqc4hBhg` |
| 📄 Full state | [PROGRESS.md](PROGRESS.md) · last push `5877205b status: yes — cami3_v11_20260926_rerun epoch 199/200 loss 1.408849954` |
| 📜 Agent transcript | [status/agent-run.log](status/agent-run.log) · `8033012 B` — every run, command & tool result |
